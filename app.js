...
first element is the product of those numbers, and the second element is a string that EXACTLY follows this
 example and concatenates a message using the arguments passed into the function:
...
function multiply(a,b) { 
  var multiResult = a * b;
  var msg = 'The product of ' + a + ' and ' + b + ' is ' + multiResult +'.';
...
Write a function called sumAndMultiply() that takes in three numbers as separate arguments and
 returns an array where the first element is the sum of those three numbers, the second element
  is the product of those three numbers,  and the third and fourth elements are strings that 
  EXACTLY follow this example and concatenates messages using the arguments that were passed into
   the function:
...
IMPORTANT DETAIL: You may not use the arithmetic operators + and * in this function. To do addition,
 ...
 ated. You're going to have to be resourceful to figure out how to do this.
...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var thirdEl = a + ' and '+ b + ' and ' + c + ' sum to ' + sum2 + '.';
  var fourthEl = 'The product of '+ a + ' and ' + b + ' and ' + c + ' is ' + product2 + '.';
  return [sum2, product2,thirdEl, fourthEl];
}
/* TODO: Here is the test for*/ 
...
then returns an array where the first element is the sum of the numbers in the array, and the 
...
function sumArray(testArray){ 
  var sum3 = sum(testArray[0],testArray[1])[0];
  var sum4 = sum(sum3, testArray[2])[0];
  var msg = testArray + ' was passed in as an array of numbers, and ' + sum4 + ' is their sum.';
  return [sum4, msg];
}
...
is a string that EXACTLY follows this example and concatenates a message using the arguments 
...
function multiplyArray(testArray){ 
    var sum5 = multiply(testArray[0],testArray[1])[0];
    var sum6 = multiply(sum5, testArray[2])[0];
    var msg = 'The numbers ' + testArray + ' have a product of ' + sum6 + '.';
    return [sum6, msg];
} 
